...
#if (!defined(CONFIG_PROJECT_P7201) && !defined(CONFIG_PROJECT_P7203))
...
#if (!defined(CONFIG_PROJECT_P7201) && !defined(CONFIG_PROJECT_P7203))	//LINE<20160622><sharp lcd  power timing>wangyanhui 
disp_en_gpio_err:
#endif
	return rc;
}
